...
#Criar uma função calcular_imposto() que calcular um imposto de 5% e retornar a quem pediu...
...
def calcular_imposto_aliquota(valor, aliquota=7):   #Poderia ser aliquota=0.07 e abaixo colocar imposto=valor*aliquota
